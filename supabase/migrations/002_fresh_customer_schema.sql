-- ============================================================================
-- FRESH CUSTOMER-ONLY SCHEMA
-- Clean implementation for Wyshkit customer platform
-- Run AFTER 000_complete_cleanup.sql
-- ============================================================================
...
CREATE INDEX idx_partners_sponsored ON public.partners(sponsored) WHERE sponsored = true;
...
CREATE INDEX idx_items_sponsored ON public.items(sponsored) WHERE sponsored = true;
